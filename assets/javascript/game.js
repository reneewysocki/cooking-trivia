$(document).ready(function () {
    ...
    function generateLoss() {
        ...
        gameHTML = "</span></p>" + "<p class='text-center'> <span class='resultHead'>Wrong!</span> <br> The correct answer is: <b>" + questions[questionCounter].correctAnswer + "</b></p>" + "<img src='assets/images/ramsey/" + randBadGif + "' class='img-wrong img-fluid'>";
        $(".mainArea").html(gameHTML);
        setTimeout(next, 3000);
        incorrect++;
    };
